...
class AddBlockAppScreen extends StatefulWidget {
  static const String routeName = '/search-app-block';
  const AddBlockAppScreen({super.key});

  @override
  State<AddBlockAppScreen> createState() => _AddBlockAppState();
}

class _AddBlockAppState extends State<AddBlockAppScreen> {
